  ...
  return (
    <div className='bg-black overflow-auto p-4 h-screen text-white'>
      ...
      <div className='flex justify-center gap-6 item-center p-4'>
        ...
        className='bg-amber-400 text-sm cursor-pointer active:scale-95 justify-center rounded px-4 py-2 font-semibold'
        onClick={()=>{
          if(index>1){
          setIndex(index-1)
          setUserData([])
        ...
        Prev</button>
        <h4>page {index} </h4>
        <button className='bg-amber-400 text-sm cursor-pointer active:scale-95 justify-center rounded px-4 py-2 font-semibold'
        onClick={()=>{
          setIndex(index+1)
          setUserData([])
        }}
